...
CREATE TABLE `21_salon_tbl` (
  ...
  `salon_map` varchar(250) NOT NULL,
...
INSERT INTO `21_salon_tbl` (`salon_id`, `salon_pw`, `salon_name`, `salon_tel`, `salon_addr1`, `salon_addr2`, `salon_email`, `salon_hp`, `salon_insta`, `salon_blog`, `salon_fb`, `salon_map`, `salon_zoom`, `salon_ptp_image`, `salon_ptp_logo`, `salon_ptp_karte`, `salon_ptp_hp`, `salon_ptp_prepaid`, `salon_ptp_profile_change`, `salon_ptp_thank_you`) VALUES
(102, '102', 'サロン G\'s1', '092-123-456', '福岡市中央区大名1-2-3', 'Gsビル4階', 'aaa', 'bbb', 'ccc', 'ddd', 'eea', 'fffa', 'https://zoom.us/j/9524815855?pwd=cjF0anV4ckRjWDFMOGplVFg5ZS9LQT09', 1, 0, 0, 0, 0, 0, 1);
...
(1, 1001, 102, 'xN3qZn9X', '新垣 結衣', 'アラガキ ユイ', '5843682', '2020/10/31', 1, 'yui@aragaki.com', '012-4546-666', '0', '2020/09/14', '2020/10/17', 0, '1新垣 結衣アラガキ ユイ'),
...
(7, 1007, 102, 'ZwzyqF97', '久慈 暁子', 'クジ アキコ', '33333333333', '2021/10/12', 1, 'akiko@kuji.com', '333-333-3333', '0', '2020/10/01', '2020/10/17', 0, '7久慈 暁子クジ アキコ'),
