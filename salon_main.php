...
<body>
	...
	<div class='div_page' id='div_page_timetable'>
		...
		<div class="page_title">
			<ul class="icon_list">
				<li><button class='btn_manage_user'><span><i class="fas fa-users"></i></span>顧客管理</button></li>
				<li><button class='btn_manage_order'><span><i class="far fa-clipboard"></i></span>予約/カルテ管理</button></li>
				<li><button class='btn_set_salon_data'><span><i class="fas fa-cog"></i></span>サロン情報設定</button></li>
				<li><button class='btn_go_square_dashboard'><span><i class="far fa-credit-card"></i></span>決済ダッシュボード</button></li>
				<li><a id='ahr_zoom' href='' target='_blank'><span><i class="fas fa-video"></i></span>ZOOMリンク</a></li>
			</ul>
		</div>
		<div class="div_tt_search">
			<div>
			...
			<div>
				<span></span>
				<input type='text' id='txt_search_tt_word' placeholder='名前/フリガナ/担当者/メニュー'>
				<button id='btn_search_tt' class="btn_search_tt">検索</button>
			</div>
		</div>
	...
	<div class='div_page' id='div_page_manage_user'>
		...
		<div>
			<span></span>
			<input type='text' class='txt_search_user' id='txt_search_user' placeholder='ID/名前/フリガナ ※空欄で全検索'>
			<button class="btn_search_user" id='btn_search_user'>検索</button><span>表示：フリガナ順</span>
	...
	<div class='div_page' id='div_page_edit_user'>
		...
		<div class='div_user_birthday_sex'>
			<span>生年月日</span><input type='date' class='txd_user_birthday'>
			<span>性別</span><br>
			<label class='txt_user_sex'><input type='radio' name='rdo_edit_user_sex' value='1' checked>女</label>
		...
		<div class='div_delete_user'>
			...
			<button class='btn_reg_user' id='btn_reg_user'>登録</button>
	...
	<div class='div_page' id='div_page_add_order'>
		...
		<div id='div_tbl_add_order'>
			<table id='tbl_add_order'>
				<thead>
					<tr>
						<th rowspan='3'>顧客ID<br>HotPepper ID</th>
						<th rowspan='3'>名前</th>
						<th colspan='6'>予約</th>
						<th rowspan='3'>カルテ</th>
					</tr>
	...
	<div class='div_page' id='div_page_show_order_counsel_result'>
		...
		<div id='div_show_order_flg_counsel_yet'></div>
	...
	<div class='div_page' id='div_page_show_order_karte'>
		...
		<div>
			...
			<div>
				<div id='div_show_order_karte'>div_show_order_karte</div>
			</div>
		</div>
	...
	<div class='div_page' id='div_page_edit_order_karte'>
		...
		<div><label><input type='checkbox' class='cbx_mode_del_photo'>写真削除モード</label>
			<div id='div_edit_order_karte'>div_edit_order_karte</div>
		</div>
		<div>
	...
	<div class='div_page' id='div_page_manage_order'>
		...
		<div>
			<input type='text' id='txt_search_order' placeholder='ID/名前/フリガナ ※空欄で全検索'>
			<button class='btn_search_order' id='btn_search_order'>検索</button>
		</div>
	...
	<div class='div_page' id='div_page_show_salon_data'>
		...
		<div>
			...
			<div><span>Youtube：</span><span class='spn_salon_youtube'>spn_salon_youtube</span></div>
			<div><span>マップリンク：</span><span class='spn_salon_map'>spn_salon_map</span></div>
			<div><span>Zoomリンク：</span><span class='spn_salon_zoom'>spn_salon_zoom</span></div>
			<div>
				サロンイメージ
		...
		<hr>
		<button class='btn_edit_salon_data' id='btn_edit_salon_data' value='salon_id'>編集</button>
		<button class='btn_back'>戻る</button>
	</div>
	...
	<div class='div_page' id='div_page_edit_salon_data'>
		...
		<div>
			...
			<div><span>Youtube：</span><input type='text' class='txt_salon_youtube' value='txt_salon_youtube'></div>
			<div><span>マップリンク：</span><input type='text' class='txt_salon_map' value='txt_salon_map'></div>
			<div><span>Zoomリンク：</span><input type='text' class='txt_salon_zoom' value='txt_salon_zoom'></div>
			<div><label><input type='checkbox' class='cbx_mode_del_photo'>写真削除モード</label>
				<div>
					サロンイメージ（5枚以内）
					<div class='div_photo_picker ptp_image'>クリックして画像選択</div>
				</div>
				<div>
					サロンロゴ（1枚）
					<div class='div_photo_picker ptp_logo'>クリックして画像選択</div>
				</div>
				<div>
					カルテ（1枚）
					<div class='div_photo_picker ptp_karte'>クリックして画像選択</div>
				</div>
				<div>
					ホームページ（1枚）
					<div class='div_photo_picker ptp_hp'>クリックして画像選択</div>
				</div>
				<div>
					決済確認（1枚）
					<div class='div_photo_picker ptp_prepaid'>クリックして画像選択</div>
				</div>
				<div>
					プロフィール変更（1枚）
					<div class='div_photo_picker ptp_profile_change'>クリックして画像選択</div>
				</div>
				<div>
					ありがとう画面（1枚）
					<div class='div_photo_picker ptp_thank_you'>クリックして画像選択</div>
				</div>
			</div>
		</div>
		<div>
			<button class='btn_reg_salon_data' id='btn_reg_salon_data'>登録</button>
			<button class='btn_cancel'>キャンセル</button>
		</div>
	</div>
